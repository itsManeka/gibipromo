				...
				<div className="flex items-center justify-between gap-2">
					...
					{unreadCount > 0 && (
						<button
							...
							className="flex items-center gap-1 text-xs font-medium text-purple-600 dark:text-white hover:text-purple-800 dark:hover:text-primary-yellow transition-colors whitespace-nowrap"
			...
			<div className="max-h-96 overflow-y-auto">
				{loading && recentNotifications.length === 0 ? (
					...
					<div className="p-8 text-center">
						<div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-purple-400 dark:border-primary-400"></div>
					...
					<div>
						{recentNotifications.map((notification) => (
							<div key={notification.id} className="border-b border-gray-200 dark:border-purple-600/50 last:border-b-0">
								<NotificationItem
			...
			{recentNotifications.length > 0 && (
				<div className="px-4 py-3 border-t border-gray-200 dark:border-purple-600 bg-gray-50 dark:bg-purple-800/50">
					<Link
						to="/notificacoes"
						onClick={onClose}
						className="block text-center text-sm font-medium text-purple-600 dark:text-white hover:text-purple-800 dark:hover:text-primary-yellow transition-colors"
					>
